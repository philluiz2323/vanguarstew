...
| Dual order share headline | `test_headline_happy_path_exact_format`, `test_headline_zero_total_unavailable`, `test_headline_none_share_shows_na`, `test_headline_nan_share_shows_na`, `test_headline_non_dict_summary_coerced` |
